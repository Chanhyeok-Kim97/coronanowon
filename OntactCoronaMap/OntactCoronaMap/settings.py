"""
Django settings for OntactCoronaMap project.
...
SECRET_KEY = '=jw=kx(j7vl0l_d$0jkhy5!9fnyuhjd!_jer@u8a147r#rvj2^'
...
ROOT_URLCONF = 'OntactCoronaMap.urls'
...
WSGI_APPLICATION = 'OntactCoronaMap.wsgi.application'
